from dataset.RAVEN.generate_helper.AoT import Component, Layout, Root, Structure
from dataset.RAVEN.generate_helper.constraints import (
    gen_entity_constraint, gen_layout_constraint, rule_constraint
)
...
def build_distribute_four_uniform():
    # Build AoT here
    root = Root("Scene")
    ...
    # Distribute_Four
    entity_constraint = gen_entity_constraint(type_min=1, angle_min=3, angle_max=3)
    layout_constraint = gen_layout_constraint("planar",
                                              [(0.25, 0.25, 0.5, 0.5),
                                               (0.25, 0.75, 0.5, 0.5),
                                               (0.75, 0.25, 0.5, 0.5),
...
def build_distribute_nine_uniform():
    # Build AoT here
    root = Root("Scene")
...
def build_in_distribute_four_out_center_single_uniform():
    # Build AoT here
    root = Root("Scene")
    ...
    # In_Four
    entity_constraint = gen_entity_constraint(type_min=1, size_min=2, angle_min=3, angle_max=3)
    layout_constraint = gen_layout_constraint("planar",
                                              [(0.42, 0.42, 0.15, 0.15),
                                               (0.42, 0.58, 0.15, 0.15),
                                               (0.58, 0.42, 0.15, 0.15),
                                               (0.58, 0.58, 0.15, 0.15)],
                                              num_min=0, num_max=3, uni_min=3)
    layout = Layout("In_Distribute_Four", layout_constraint, entity_constraint)
    comp_in.insert(layout)
