import numpy as np
from dataset.RAVEN.generate_helper.const import (
    ANGLE_MAX, ANGLE_MIN, ANGLE_VALUES, COLOR_MAX, COLOR_MIN,
...
class Number(Attribute):
    ...
    def sample_new(self, min_level=None, max_level=None):
        ...
        new_idx = np.random.choice(list(values))
        return new_idx
