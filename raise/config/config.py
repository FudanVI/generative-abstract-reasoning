...
def get_config(args):
    ...
    config['pretrain_path'] = os.path.join(config['pretrain_path'], config['dataset'], config['image_type'])
    config['run_path'] = os.path.join(config['run_path'], config['dataset'], config['image_type'], args.exp_name)
